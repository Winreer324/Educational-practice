...
class DBConnection {
	...
	public function makePreparedQuery($table, $opertationType, $rowId = "", $valuesTypes = "", $fields = "", $values = ""){
		...
		// далее в зависимости от типа операции выполняются оTпределенные действия
		if ($opertationType == 'update') {
