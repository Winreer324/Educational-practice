...
?>
		...
		<div class=" max-lg-5">
			<div class="container-fluid pt-3">
				<div class="d-flex justify-content-end border=buttom border-primary pb-3">
					...
					<buttom class="btn blue-gradient btn-sm my-0 p w-0 mr-3 btn_creat_services">Добавить</buttom>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="creat card mb-5">
		...
		<div class="row person creat_input  pt-4 pb-5 "> 
			<input class="item col-md-2 ml-5 " type="text" placeholder="Дата посещения">
			<input class="item col-md-2 ml-5 " type="text" placeholder="Услуга"> 
			<div class="row ml-5 test">
				<button class="btn_creat_services_true border-primary blue-gradient btn">
					<i class="creat_check">add</i>
				</button>
				<button class="btn_creat_services_false ml-3 border-primary blue-gradient btn">
	...
	<div id="person" class="card">
		...
		<!-- <div class="row  mr-0 pt-4 pb-5 ">
			...
			<input class="item col-md-2 ml-5 " type="text" placeholder="Услуга">  -->
<!-- <input class='item col-md-2 ml-4 ' type='text' placeholder='' value='{".@$data[$i]["services_data_visit_id"]."}'> -->
			<?php
                  ...
                  for($i = 0, $count = sizeof($data); $i < $count; $i++) // выводим данные в виде строк HTML-таблицы 
                  {
                  	...
                  	<div class='row person input pt-4 pb-5 mr-0 ml-2'>
						<input class='item col-md-2 ml-3 id_id' type='text' placeholder='#' value='{$data[$i]['id_services']}'>
						<input class='item col-md-2 ml-4 ' type='text' placeholder='' value='{$data[$i]['services_date_visit_id']}'>
